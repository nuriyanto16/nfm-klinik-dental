...
type CreateReservationInput struct {
	...
	// Status defaults to "pending" (the normal booking flow). A draft booking passes "draft".
	// A POS/walk-in checkout passes "completed" directly.
	Status string `json:"status"`
}
...
// ReservationStatuses in the lifecycle order the admin UI offers
var ReservationStatuses = []string{"draft", "pending", "confirmed", "checked_in", "in_progress", "completed", "cancelled", "no_show", "deleted"}

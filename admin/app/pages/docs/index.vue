...
const paymentMethods = ['QRIS', 'Transfer BCA', 'Transfer Mandiri', 'Transfer BNI', 'OVO', 'GoPay', 'Dana', 'ShopeePay']
      ...
      <div class="lg:col-span-3 space-y-6">
            ...
            <div class="space-y-5 text-sm">
              ...
              <div>
                ...
                <ol class="space-y-3 list-none">
                  <li
                    v-for="(step, i) in gettingStartedSteps"
                    :key="i"
        ...
        <div v-if="activeSection === 'reservasi'" class="space-y-5">
          <UCard>
            ...
            <div class="space-y-4 text-sm">
              <div
                v-for="(step, i) in reservationSteps"
                :key="i"
              ...
              >
                <div class="relative">
                  ...
                  <div v-if="i < reservationSteps.length - 1" class="absolute left-4 top-9 w-0.5 h-6 bg-gray-200 dark:bg-gray-700" />
                </div>
          ...
          <UCard>
            ...
            <div class="space-y-4 text-sm">
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div
                  v-for="item in medicalRecordItems"
                  :key="item.title"
                  class="border border-default rounded-xl p-4"
                >
            ...
            <div class="space-y-4 text-sm">
              <div class="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-950/30 dark:to-purple-950/30 border border-pink-200 dark:border-pink-800">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-xs text-muted">Nina Dental Care — v1.0.0 (58.6 MB)</p>
                </div>
          ...
          <UCard>
            ...
            <div class="space-y-4 text-sm">
              <div class="p-3 rounded-xl bg-gray-900 text-green-400 font-mono text-xs space-y-1">
                ...
                <p>{{ API_URL }}</p>
                <p class="text-gray-500 mt-2"># Authentication</p>
